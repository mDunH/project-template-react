...
export function createContext(options = {}) {
    const displayName =
        typeof options === "string" ? options : options.displayName;
    ...
    class Provider extends React.Component {
        ...
        render() {
            ...
            return (
                <Context.Provider
                    value={{ ...value, changeContext: this.changeContext }}
                >
    ...
    return {
        ...
        [`inject${displayName}`]: injectApp
    };
}

export function createContexts(contextNames) {
    if (typeof contextNames === "string") {
        contextStorehouse[contextNames] = createContext({
            displayName: contextNames
        });
